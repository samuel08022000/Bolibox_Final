...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="menuAdmin">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= url('admin/clientes') ?>"><i class="bi bi-people"></i> Clientes</a></li>
    ...
    <div class="container py-4 mt-3">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-naranja m-0"><i class="bi bi-people"></i> Lista de Clientes</h3>
            <button class="btn bg-naranja text-white fw-bold"><i class="bi bi-person-plus"></i> Nuevo Cliente</button>
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Pedro Lopez</td>
                                <td><i class="bi bi-telephone text-muted"></i> 77777777</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Maria Gomez</td>
                                <td><i class="bi bi-telephone text-muted"></i> 76543210</td>
                                <td>
                                    <button class="btn btn-sm btn-outline-dark"><i class="bi bi-pencil"></i></button>
                                    <button class="btn btn-sm btn-outline-danger"><i class="bi bi-trash"></i></button>
                                </td>
