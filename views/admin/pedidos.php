...
<body>
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="menuAdmin">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?= url('admin/pedidos') ?>"><i class="bi bi-clipboard-data"></i> Pedidos</a></li>
    ...
    <div class="container py-4 mt-3">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-naranja m-0"><i class="bi bi-clipboard-data"></i> Gestión de Pedidos</h3>
            <button class="btn bg-naranja text-white fw-bold"><i class="bi bi-cart-plus"></i> Nuevo Pedido</button>
        </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Juan Perez</td>
                                <td><i class="bi bi-calendar3 text-muted"></i> 10/06/2026</td>
                                <td class="fw-bold text-success">200 Bs</td>
